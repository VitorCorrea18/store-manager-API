...
const HTTP_CREATED = { status: 201 };
const HTTP_ACCEPTED = { status: 202 };
const HTTP_NO_CONTENT = { status: 204 };

// Client Error
const HTTP_BAD_REQUEST = { status: 400 };
const HTTP_NOT_FOUND = { status: 404 };
const HTTP_CONFLIT = { status: 409 };
const HTTP_UNPROCESSABLE_ENTRY = { status: 422 };
